...
- Dataset files and model weights are not included in this repository; you must provide them locally e.g. Google Colab [`modelForPredictingBiomass`](modelForPredictingBiomass.ipynb)
